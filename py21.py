 #Make a program that allow the user to enter acountry name and capital to search for then show the following informatio
...
17000000), ('Tunisia', 'Tunis', 'Africa', 'Arabic', 11000000),
('United Arab Emirates', 'Abu Dhabi', 'Asia', 'Arabic', 10000000), ('Yemen', "Sana'a",
...
('Nigeria', 'Abuja', 'Africa', 'English', 200000000), ('Ethiopia', 'AddisAbaba', 'Africa', 'Amharic', 110000000), 
('Albania', 'Tirana', 'Europe','Albanian', 2877797), ('Andorra', 'Andorra la Vella', 'Europe', 'Catalan',77006), 
('Austria', 'Vienna', 'Europe', 'German', 8955102), ('Belarus', 'Minsk', 'Europe', 'Belarusian', 9449323), 
('Belgium', 'Brussels', 'Europe','Dutch, French, German', 11519193), ('Bosnia and Herzegovina', 'Sarajevo',
'Europe', 'Bosnian, Serbian, Croatian', 3280819), ('Bulgaria', 'Sofia',
'Europe', 'Bulgarian', 6948445), ('Croatia', 'Zagreb', 'Europe', 'Croatian',
4105267), ('Cyprus', 'Nicosia', 'Europe', 'Greek, Turkish', 1189265),
 ('Czech Republic', 'Prague', 'Europe', 'Czech', 10618303), ('Denmark', 'Copenhagen',
'Europe', 'Danish', 5792202), ('Estonia', 'Tallinn', 'Europe', 'Estonian',1324333), 
('Finland', 'Helsinki', 'Europe', 'Finnish, Swedish', 5540720),
...
'Macedonian', 2083374), ('Canada', 'Ottawa', 'North America', 
'English', 'French', 38550000), ('United States', 'Washington, D.C.', 'North America',
...
while True:
    message = input("Enter a country name or capital to search: ")
    for data  in countries:
        if data[0].lower() == message.lower():
            country,capital,countinent,language,population = data
            print(f"Country: {country}\nCapital: {capital}\nCountinent: {countinent}\nLanguage: {language}\nPopulation: {population}")
