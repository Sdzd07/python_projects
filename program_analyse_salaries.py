#this script analyse the salary on the list and give the user the greater&smaller and the medium of salary
...
if  comma not in salaries or salaries == comma:
...
else:#change the input form to the list by using split method 
    ...
    #analyse the greater salary in the list by using max method 
     max_salary = max(float_salaries)
     print(f"The greater salary is: {max_salary} $")
    #analyse the smaller salary in the list by using max method 
     min_salary = min(float_salaries)
     print(f"The smaller salary is: {min_salary} $")
    ...
    # and division the total on number of items have on the list (salaries)
     ...
     medium_salary = sum_salarys/len(float_salaries)
     print(f"The medium salary is: {medium_salary} $")