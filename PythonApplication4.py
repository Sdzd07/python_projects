...
#get input from user 
item = input("What pizza you want :").lower().capitalize()
...
pizzas_menu = {"Margherita": 100, "Pepperoni": 120, "Meat Lovers":
150, "Chicken": 130}
for pizza in pizzas_menu:
    pizzas_menu[pizza] = f"{pizzas_menu[pizza]*1.2:.2f}"
print(pizzas_menu)
print("_"*40)
for item in pizzas_menu:
    print(f"{item} : {pizzas_menu[item]}")
#other solution
pizzas_menu_ = {"Margherita": 100, "Pepperoni": 120, "Meat Lovers":
150, "Chicken": 130}
